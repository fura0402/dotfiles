...
function M.setup()
    ...
    Color.new('backgroundBG', '#002b36')
    Color.new('backgroundFG', '#839496')
    Color.new('blanklineC', '#586e75')
    Color.new('blanklineCC', '#93a1a1')

    n.Group.new('Normal', colors.backgroundFG, colors.backgroundBG)
    ...
    n.Group.new('IndentBlanklineChar', colors.blanklineC)
    n.Group.new('IndentBlanklineContextChar', colors.blanklineCC)
